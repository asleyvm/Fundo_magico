...
document.addEventListener("DOMContentLoaded", function () {
    ...
    form.addEventListener("submit", async function (event) {
        ...
        try {
            ...
            const response = await fetch("https://rixani.app.n8n.cloud/webhook/gerador-codigo", {
            ...
            htmlCode.textContent = "Erro ao gerar o background HTML. Tente novamente.";
            cssCode.textContent = "Erro ao gerar o background CSS. Tente novamente.";
            preview.innerHTML = "";
        } finally {
            setLoading(false);
        }
